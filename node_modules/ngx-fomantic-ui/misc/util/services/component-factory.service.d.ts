import { ApplicationRef, ComponentFactoryResolver, ComponentRef, Injector, Provider, TemplateRef, Type, ViewContainerRef } from '@angular/core';
export interface IImplicitContext<T> {
    $implicit?: T;
}
export declare class FuiComponentFactory {
