...
function TagComponent_div_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵattribute("contenteditable", ctx_r284.editing);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngTemplateOutletContext", ɵngcc0.ɵɵpureFunction2(3, _c1, ctx_r284.model, ctx_r284.index))("ngTemplateOutlet", ctx_r284.template);
} }
function TagComponent_div_2_delete_icon_3_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function TagComponent_div_2_delete_icon_3_Template_delete_icon_click_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r290); const ctx_r289 = ɵngcc0.ɵɵnextContext(2); return ctx_r289.remove($event); });
    ɵngcc0.ɵɵelementEnd();
} }
function TagComponent_div_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("keydown.enter", function TagComponent_div_2_Template_div_keydown_enter_1_listener($event) { ɵngcc0.ɵɵrestoreView(_r292); const ctx_r291 = ɵngcc0.ɵɵnextContext(); return ctx_r291.disableEditMode($event); })("keydown.escape", function TagComponent_div_2_Template_div_keydown_escape_1_listener($event) { ɵngcc0.ɵɵrestoreView(_r292); const ctx_r293 = ɵngcc0.ɵɵnextContext(); return ctx_r293.disableEditMode($event); })("click", function TagComponent_div_2_Template_div_click_1_listener($event) { ɵngcc0.ɵɵrestoreView(_r292); const ctx_r294 = ɵngcc0.ɵɵnextContext(); return ctx_r294.editing ? $event.stopPropagation() : undefined; })("blur", function TagComponent_div_2_Template_div_blur_1_listener($event) { ɵngcc0.ɵɵrestoreView(_r292); const ctx_r295 = ɵngcc0.ɵɵnextContext(); return ctx_r295.onBlurred($event); });
    ɵngcc0.ɵɵtext(2);
    ɵngcc0.ɵɵelementEnd();
    ...
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵattribute("contenteditable", ctx_r285.editing)("title", ctx_r285.getDisplayValue(ctx_r285.model));
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵtextInterpolate1(" ", ctx_r285.getDisplayValue(ctx_r285.model), " ");
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", ctx_r285.isDeleteIconVisible());
} }
function TagComponent_tag_ripple_3_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("state", ctx_r286.rippleState);
...
function TagInputDropdown_ng2_menu_item_2_span_1_Template(rf, ctx) { if (rf & 1) {
    ...
    const item_r297 = ɵngcc0.ɵɵnextContext().$implicit;
    const ctx_r300 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("innerHTML", ɵngcc0.ɵɵpipeBind2(1, 1, item_r297[ctx_r300.displayBy], ctx_r300.tagInput.inputForm.value.value), ɵngcc0.ɵɵsanitizeHtml);
} }
...
function TagInputDropdown_ng2_menu_item_2_2_Template(rf, ctx) { if (rf & 1) {
    ...
    const item_r297 = ctx_r304.$implicit;
    const index_r298 = ctx_r304.index;
    const last_r299 = ctx_r304.last;
    const ctx_r301 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("ngTemplateOutlet", ctx_r301.templates.first)("ngTemplateOutletContext", ɵngcc0.ɵɵpureFunction3(2, _c2, item_r297, index_r298, last_r299));
} }
function TagInputDropdown_ng2_menu_item_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("value", item_r297)("ngSwitch", !!ctx_r296.templates.length);
    ɵngcc0.ɵɵadvance(1);
...
function TagInputComponent_tag_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("onSelect", function TagInputComponent_tag_2_Template_tag_onSelect_0_listener() { ɵngcc0.ɵɵrestoreView(_r311); const item_r308 = ctx.$implicit; const ctx_r310 = ɵngcc0.ɵɵnextContext(); return ctx_r310.selectItem(item_r308); })("onRemove", function TagInputComponent_tag_2_Template_tag_onRemove_0_listener() { ɵngcc0.ɵɵrestoreView(_r311); const item_r308 = ctx.$implicit; const i_r309 = ctx.index; const ctx_r312 = ɵngcc0.ɵɵnextContext(); return ctx_r312.onRemoveRequested(item_r308, i_r309); })("onKeyDown", function TagInputComponent_tag_2_Template_tag_onKeyDown_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r311); const ctx_r313 = ɵngcc0.ɵɵnextContext(); return ctx_r313.handleKeydown($event); })("onTagEdited", function TagInputComponent_tag_2_Template_tag_onTagEdited_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r311); const ctx_r314 = ɵngcc0.ɵɵnextContext(); return ctx_r314.updateEditedTag($event); })("onBlur", function TagInputComponent_tag_2_Template_tag_onBlur_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r311); const i_r309 = ctx.index; const ctx_r315 = ɵngcc0.ɵɵnextContext(); return ctx_r315.onTagBlurred($event, i_r309); })("dragstart", function TagInputComponent_tag_2_Template_tag_dragstart_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r311); const item_r308 = ctx.$implicit; const i_r309 = ctx.index; const ctx_r316 = ɵngcc0.ɵɵnextContext(); return ctx_r316.dragZone ? ctx_r316.onDragStarted($event, item_r308, i_r309) : undefined; })("drop", function TagInputComponent_tag_2_Template_tag_drop_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r311); const i_r309 = ctx.index; const ctx_r317 = ɵngcc0.ɵɵnextContext(); return ctx_r317.dragZone ? ctx_r317.onTagDropped($event, i_r309) : undefined; })("dragenter", function TagInputComponent_tag_2_Template_tag_dragenter_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r311); const ctx_r318 = ɵngcc0.ɵɵnextContext(); return ctx_r318.dragZone ? ctx_r318.onDragOver($event) : undefined; })("dragover", function TagInputComponent_tag_2_Template_tag_dragover_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r311); const i_r309 = ctx.index; const ctx_r319 = ɵngcc0.ɵɵnextContext(); return ctx_r319.dragZone ? ctx_r319.onDragOver($event, i_r309) : undefined; })("dragleave", function TagInputComponent_tag_2_Template_tag_dragleave_0_listener() { ɵngcc0.ɵɵrestoreView(_r311); const ctx_r320 = ɵngcc0.ɵɵnextContext(); return ctx_r320.dragZone ? ctx_r320.dragProvider.onDragEnd() : undefined; });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const item_r308 = ctx.$implicit;
    const i_r309 = ctx.index;
    const ctx_r305 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵpropertyInterpolate("draggable", ctx_r305.editable);
    ɵngcc0.ɵɵproperty("canAddTag", ctx_r305.isTagValid)("disabled", ctx_r305.disable)("@animation", ctx_r305.animationMetadata)("hasRipple", ctx_r305.ripple)("index", i_r309)("removable", ctx_r305.removable)("editable", ctx_r305.editable)("displayBy", ctx_r305.displayBy)("identifyBy", ctx_r305.identifyBy)("template", !!ctx_r305.hasCustomTemplate() ? ctx_r305.templates.first : undefined)("draggable", ctx_r305.dragZone)("model", item_r308);
...
function TagInputComponent_div_6_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("ngClass", ctx_r307.theme);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngForOf", ctx_r307.errors);
} }
const _c3 = ["*"];
